...
import HorizontalJourney from '@/features/experience/HorizontalJourney';
import MarketingHeader from '@/layouts/MarketingHeader';
import MarketingFooter from '@/layouts/MarketingFooter';
...
export default function LandingPage() {
  ...
  // Hide the marketing header while the cinematic journey is pinned.
  useLayoutEffect(() => {
    if (reduceMotion || !journeyRef.current) return undefined;
  ...
  // Fade the scroll cue once the user starts moving.
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-slateCustom-900 text-white flex flex-col bg-grid">
      <MarketingHeader hidden={journeyActive} />
      ...
      <main className="flex-1">
        ...
        <section className="relative min-h-[92vh] flex items-center">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20 w-full">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-extrabold leading-[1.05] tracking-tight">
                Share rides with people <span className="gradient-text">you trust.</span>
              </h1>

              <p className="text-white/60 text-base sm:text-xl leading-relaxed max-w-2xl">
                Ride Share connects verified passengers and drivers for carpools and on-demand
                trips. Save money, cut traffic, and commute smarter — together.
              </p>
          ...
          {/* Scroll cue into the journey */}
          <button
            type="button"
            onClick={scrollToJourney}
            className={`absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 border-0 bg-transparent cursor-pointer text-white/45 hover:text-white/80 transition-all duration-500 ${
